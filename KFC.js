...
const dataload = () => {
    ...
    setTimeout(() => {
        sec_title.innerHTML = "BARGAIN <br>BUCKET MENU <br>CAMPAING";
    ...
    setTimeout(() => {
        sec_title.innerHTML = "BARGAIN <br>FRIES MENU <br>CAMPAING";
    ...
    setTimeout(() => {
        sec_title.innerHTML = "BARGAIN <br>BURGEAR MENU <br>CAMPAING";
        h6_dot[1].classList.remove("head_dots_main");
        h6_dot[2].classList.remove("head_dots_main");
